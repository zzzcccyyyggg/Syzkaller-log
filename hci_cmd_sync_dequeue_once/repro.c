...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_getsockopt, /*fd=*/-1, /*level=*/0x112, /*opt=*/0xc,
            /*arg=*/0ul, /*arglen=*/0ul);
    break;
  case 2:
    memcpy((void*)0x20000140,
           "\x43\x29\x00\x00\x1c\x00\x01\x00\x11\x7a\x3b\xc4\x02\x77\x09\x11"
           "\x89\x19\x64\x20\xed\x1a\xc8",
           23);
    syscall(__NR_write, /*fd=*/-1, /*data=*/0x20000140ul, /*size=*/0xfdeful);
    break;
  case 3:
    *(uint16_t*)0x20000000 = 0x1f;
    *(uint16_t*)0x20000002 = 7;
    memset((void*)0x20000004, 0, 6);
    *(uint16_t*)0x2000000a = 6;
